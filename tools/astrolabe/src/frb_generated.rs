    ...
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            crate::api::ActionRequest::DisplayIdentifierAdmitPassphrase { passphrase } => {
                [30.into_dart(), passphrase.into_into_dart().into_dart()].into_dart()
            }
            crate::api::ActionRequest::EnterPresentation => [31.into_dart()].into_dart(),
            ...
            .into_dart(),
            crate::api::ActionRequest::PresentRefresh => [33.into_dart()].into_dart(),
            crate::api::ActionRequest::LeavePresentation => [34.into_dart()].into_dart(),
            _ => {
                unimplemented!("");
            }
        }
