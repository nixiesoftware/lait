...
const capabilities = {
  protocol_major: 1,
  platform: "android_tv",
  build: "astrolabe-android-tv/0.1.0",
  viewport: {
...
globalThis.astrolabeReceiver = Object.freeze({
  confirmPairing: () => client.confirmPairing(),
  cancelPairing: () => client.cancelPairing(),
  toggleDetails: () => ui.toggleDetails(),
});
client.start();
