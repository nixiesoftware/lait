...
968 crates, under 50 distinct licence expressions.

## Licence expressions in this closure

| Licence | Crates |
| --- | ---: |
| `MIT OR Apache-2.0` | 430 |
| `MIT` | 210 |
| `Apache-2.0 OR MIT` | 94 |
| `MIT/Apache-2.0` | 45 |
| `Apache-2.0` | 32 |
| `Unicode-3.0` | 25 |
...
| `MIT OR Apache-2.0 OR Apache-2.0 WITH LLVM-exception` | 1 |
...
| accesskit_consumer | 0.35.0 | `MIT OR Apache-2.0` | <https://github.com/AccessKit/accesskit> |
...
| accesskit_windows | 0.32.1 | `MIT OR Apache-2.0` | <https://github.com/AccessKit/accesskit> |
...
| archery | 1.2.3 | `MIT` | <https://github.com/orium/archery> |
...
| arref | 0.1.0 | `MIT` | <https://github.com/zxch3n/arref> |
...
| chinese-variant | 1.1.6 | `MIT` | <https://github.com/magiclen/chinese-variant> |
...
| citationberg | 0.7.0 | `MIT OR Apache-2.0` | <https://github.com/typst/citationberg> |
...
| codex | 0.3.0 | `Apache-2.0` | <https://github.com/typst/codex> |
...
| derive-getters | 0.5.0 | `MIT` | <https://git.sr.ht/~kvsari/derive-getters> |
...
| ed25519-dalek | 3.0.0-pre.7 | `BSD-3-Clause` | <https://github.com/dalek-cryptography/curve25519-dalek/tree/main/ed25519-dalek> |
...
| ensure-cov | 0.1.0 | `MIT OR Apache-2.0` | <https://github.com/zxch3n/ensure-cov> |
| enum-as-inner | 0.5.1 | `MIT/Apache-2.0` | <https://github.com/bluejekyll/enum-as-inner> |
...
| frost-ed25519 | 3.0.0 | `MIT OR Apache-2.0` | <https://github.com/ZcashFoundation/frost> |
| frost-rerandomized | 3.0.0 | `MIT OR Apache-2.0` | <https://github.com/ZcashFoundation/frost> |
...
| generic-btree | 0.10.7 | `MIT` | <https://github.com/loro-dev/generic-btree> |
...
| hayagriva | 0.10.1 | `MIT OR Apache-2.0` | <https://github.com/typst/hayagriva> |
...
| hayro-svg | 0.7.0 | `Apache-2.0 OR MIT` | <https://github.com/LaurenzV/hayro> |
...
| icu_provider_blob | 2.2.0 | `Unicode-3.0` | <https://github.com/unicode-org/icu4x> |
...
| im | 15.1.0 | `MPL-2.0+` | <https://github.com/bodil/im-rs> |
...
| iroh | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/iroh> |
| iroh-base | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/iroh> |
| iroh-dns | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/iroh> |
| iroh-gossip | 0.100.0 | `MIT/Apache-2.0` | <https://github.com/n0-computer/iroh-gossip> |
| iroh-metrics | 1.0.0-rc.0 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/iroh-metrics> |
| iroh-metrics-derive | 1.0.0-rc.0 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/iroh-metrics> |
| iroh-relay | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/iroh> |
| irpc | 0.16.0 | `Apache-2.0/MIT` | <https://github.com/n0-computer/irpc> |
| irpc-derive | 0.16.0 | `Apache-2.0/MIT` | <https://github.com/n0-computer/irpc> |
...
| leb128 | 0.2.7 | `MIT OR Apache-2.0` | <https://github.com/gimli-rs/leb128> |
...
| loro | 1.13.6 | `MIT` | <https://github.com/loro-dev/loro/> |
| loro-common | 1.13.1 | `MIT` | <https://github.com/loro-dev/loro> |
| loro-delta | 1.13.0 | `MIT` | <https://github.com/loro-dev/loro/> |
| loro-internal | 1.13.6 | `MIT` | <https://github.com/loro-dev/loro/> |
| loro-kv-store | 1.13.1 | `MIT` | <https://github.com/loro-dev/loro/> |
| loro-rle | 1.6.0 | `MIT` | <https://github.com/loro-dev/loro/> |
| loro-thunderdome | 0.6.2 | `MIT OR Apache-2.0` | <https://github.com/LPGhatguy/thunderdome> |
| loro_fractional_index | 1.13.0 | `MIT` | <https://github.com/loro-dev/loro/> |
...
| n0-watcher | 1.0.0-rc.0 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/n0-watcher> |
...
| netdev | 0.43.0 | `MIT` | <https://github.com/shellrow/netdev> |
...
| netlink-packet-route | 0.30.0 | `MIT` | <https://github.com/rust-netlink/netlink-packet-route> |
...
| netwatch | 0.18.0 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/net-tools> |
...
| noq | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/noq> |
| noq-proto | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/noq> |
| noq-udp | 1.0.0-rc.1 | `MIT OR Apache-2.0` | <https://github.com/n0-computer/noq> |
...
| pest | 2.8.7 | `MIT OR Apache-2.0` | <https://github.com/pest-parser/pest> |
| pest_derive | 2.8.7 | `MIT OR Apache-2.0` | <https://github.com/pest-parser/pest> |
| pest_generator | 2.8.7 | `MIT OR Apache-2.0` | <https://github.com/pest-parser/pest> |
| pest_meta | 2.8.7 | `MIT OR Apache-2.0` | <https://github.com/pest-parser/pest> |
...
| quick_cache | 0.6.24 | `MIT` | <https://github.com/arthurprs/quick-cache> |
...
| rand_xoshiro | 0.6.0 | `MIT OR Apache-2.0` | <https://github.com/rust-random/rngs> |
...
| safe_arch | 0.7.4 | `Zlib OR Apache-2.0 OR MIT` | <https://github.com/Lokathor/safe_arch> |
...
| self-replace | 1.5.0 | `Apache-2.0` | <https://github.com/mitsuhiko/self-replace> |
| self_cell | 1.3.0 | `Apache-2.0 OR GPL-2.0-only` | <https://github.com/Voultapher/self_cell> |
| self_update | 0.44.0 | `MIT` | <https://github.com/jaemk/self_update> |
...
| serde-byte-array | 0.1.2 | `MIT OR Apache-2.0` | <https://github.com/nitrokey/serde-byte-array> |
| serde_bytes | 0.11.19 | `MIT OR Apache-2.0` | <https://github.com/serde-rs/bytes> |
| serde_columnar | 0.3.14 | `MIT OR Apache-2.0` | <https://github.com/loro-dev/columnar> |
| serde_columnar_derive | 0.3.7 | `MIT OR Apache-2.0` | — |
...
| serdect | 0.2.0 | `Apache-2.0 OR MIT` | <https://github.com/RustCrypto/formats/tree/master/serdect> |
...
| sized-chunks | 0.6.5 | `MPL-2.0+` | <https://github.com/bodil/sized-chunks> |
...
| typst | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-assets | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst-assets> |
| typst-eval | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-html | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-layout | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-library | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-macros | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-realize | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-svg | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-syntax | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-timing | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
| typst-utils | 0.15.1 | `Apache-2.0` | <https://github.com/typst/typst> |
...
| unic-langid-macros | 0.9.6 | `MIT OR Apache-2.0` | <https://github.com/zbraniecki/unic-locale> |
| unic-langid-macros-impl | 0.9.6 | `MIT OR Apache-2.0` | <https://github.com/zbraniecki/unic-locale> |
...
| wasmi_collections | 1.1.0 | `MIT/Apache-2.0` | <https://github.com/wasmi-labs/wasmi> |
| wasmi_core | 1.1.0 | `MIT/Apache-2.0` | <https://github.com/wasmi-labs/wasmi> |
...
| wide | 0.7.33 | `Zlib OR Apache-2.0 OR MIT` | <https://github.com/Lokathor/wide> |
...
| xxhash-rust | 0.8.16 | `BSL-1.0` | <https://github.com/DoumanAsh/xxhash-rust> |
...
| zipsign-api | 0.1.5 | `MIT OR Apache-2.0 OR Apache-2.0 WITH LLVM-exception` | <https://github.com/Kijewski/zipsign> |
