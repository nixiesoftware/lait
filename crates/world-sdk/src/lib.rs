...
impl From<runtime::exec::Failure> for ExecFailure {
    fn from(value: runtime::exec::Failure) -> Self {
        match value {
            ...
            runtime::exec::Failure::OutputLimit => Self::OutputLimit,
            runtime::exec::Failure::OutputUnavailable => Self::OutputUnavailable,
            runtime::exec::Failure::InputUnavailable => Self::InputUnavailable,
            runtime::exec::Failure::Terminal(_) => Self::Terminal,
...
impl ExecFailure {
    fn runtime(self) -> runtime::exec::Failure {
        match self {
            ...
            Self::OutputLimit => runtime::exec::Failure::OutputLimit,
            Self::OutputUnavailable => runtime::exec::Failure::OutputUnavailable,
            Self::InputUnavailable => runtime::exec::Failure::InputUnavailable,
            Self::Terminal => {
                runtime::exec::Failure::Terminal(runtime::exec::TerminalFailure::Unavailable)
            }
