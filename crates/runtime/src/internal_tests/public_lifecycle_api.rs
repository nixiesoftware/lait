...
use runtime::plane::contact::Failure as ContactFailure;
use runtime::world::Failure as SessionFailure;
use runtime::{
    neighbor::State as Neighbor, plane::contact::Outcome as ContactOutcome, plane::Activation,
    world::CommittedEffect, world::Intent, world::LocalIdentity, world::ObservationCursor,
    world::Projection, world::Query, world::Rejection, world::RequestId, world::SignedWorldAction,
    Orbit, OrbitStatus, RemovalConfirmation, Runtime, Session, Station,
};
...
fn the_target_lifecycle_methods_have_their_frozen_signatures() {
    ...
    ) -> Result<Orbit, LifecycleFailure> = Runtime::materialize;
    ...
    // Orbit
    let _: fn(Orbit, Activation) -> Result<Station, LifecycleFailure> = Station::open;
    ...
    let _: fn(&Session, Option<ObservationCursor>) -> runtime::world::ObservationStream =
        Session::observe;
